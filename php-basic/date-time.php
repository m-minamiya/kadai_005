...
<body>
    <p>
        ...
        //現在を基準として1週間後の日時のUMIXタイムスタンプを出力する
        echo strtotime('+1 week') . '<br>';

        //現在を基準として3年後の日時を指定したフォーマットで出力する
    ...
    <p>
        ...
        //インスタンス$date_timeに日時を特定のフォーマットで出力する
        echo $date_time->format('Y年n月j日H時i分s秒') . '<br>';
        
        //現在の日時のインスタンスを作成する
        $now = new DateTime();

        //diff()メソッドで2つのインスタンスの日時の差を取得し、変数$intervalに代入する
